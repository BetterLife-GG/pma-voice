...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{ 3.0, "Szept" }, -- Whisper speech distance in gta distance units
		{ 7.0, "Normalny" }, -- Normal speech distance in gta distance units
		{ 15.0, "Krzyk" } -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{ 3.0, "Szept" }, -- Whisper speech distance in gta distance units
